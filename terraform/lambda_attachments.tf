# 1. S3 Bucket for Attachments (Public Access Blocked, CORS enabled) (Checklist #20, #24)
...
# Block all public access (Checklist #20)
...
# CORS configuration for S3 Presigned Upload URLs (Checklist #24)
...
# 2. Package Python Lambda Source Code into Zip (Checklist #23)
...
# 3. IAM Role for Lambda (Checklist #23)
...
# Custom Scoped Policy for Thumbnail Generator Lambda (Checklist #23)
...
# 4. AWS Lambda Function for Thumbnail Generation (Python 3.11) (Checklist #23)
...
# 5. Permission for S3 to invoke Lambda (Checklist #23)
...
# 6. S3 Event Notification triggering Lambda on object creation under uploads/ (Checklist #23)
